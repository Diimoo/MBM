...
Object.entries(formulas).forEach(([name, latex]) => {
    ...
    // Add significant padding for a clear card appearance
...
<svg xmlns="http://www.w3.org/2000/svg" width="${nvw/10}px" height="${nvh/10}px" viewBox="${nvx} ${nvy} ${nvw} ${nvh}" role="img" style="background-color: #FFFFFF;">
  ...
  <g fill="#000000" stroke="#000000" stroke-width="0">
    ...
    fs.writeFileSync(path.join(assetsDir, `${name}_v11.svg`), finalSvg);
    console.log(`Generated ${name}_v11.svg`);
});
